...
Please check your previous implementation of the function and the test failures it had.
Focus on ALL the bugs that caused the failures.Then modify your implementation to fix ALL the bugs(missing uppercase, missing digit, missing special). 
Output ONLY a single fenced Python code block that defines the function is_valid_password(password: str) -> bool.
The new version should be the same format as the previous implementation.
"""
